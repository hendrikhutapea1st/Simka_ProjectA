  ...
  <section id="home" class="bg-gradient-to-r from-green-50 to-emerald-50 py-4 sm:py-6 md:py-8 lg:py-10" aria-label="Bagian utama - SIMKA Buah Medan">
    <div class="container mx-auto px-3 sm:px-4 flex flex-col md:flex-row items-center gap-3 md:gap-6">
      <div class="w-full md:w-1/2 animate-fade-in-left">
        <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-4 tracking-tight animate-fade-in-up animate-duration-300 animate-delay-100">
          SIMKA Buah <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-500">Medan</span> <br><span class="typewriter-text text-xl sm:text-2xl md:text-3xl mt-2 block font-semibold">{{ currentText }}<span class="cursor">|</span></span>
        </h1>
        <p class="text-lg sm:text-xl text-gray-600 mb-8 max-w-lg leading-relaxed animate-fade-in-up animate-duration-300 animate-delay-200">
          Menyediakan berbagai jenis <strong>buah segar</strong>, buah organik, dan buah lokal Medan terbaik. Berkualitas tinggi dan dikemas higienis.
        </p>
        <div class="flex flex-wrap gap-3 animate-fade-in-up animate-duration-300 animate-delay-300" role="group" aria-label="Tautan pemesanan">
          <WhatsAppButton
            ...
            button-text="Pesan Admin 1"
            button-class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:shadow-green-200/50 hover:-translate-y-1 transition duration-300 text-center flex items-center gap-2"
          />
          <WhatsAppButton
            :phone-number="'6289508284808'"
            :message="'Halo SIMKA Buah! Saya tertarik dengan buah segar Medan berkualitas. Mohon bantuannya untuk pesan buah segar terbaik yang tersedia saat ini.'"
            button-text="Pesan Admin 2"
            button-class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:shadow-emerald-200/50 hover:-translate-y-1 transition duration-300 text-center flex items-center gap-2"
          />
          <a
            href="https://gofood.co.id/medan/restaurant/simka-fresh-pajak-cempaka-jl-cempaka-6a22dc19-3fcd-4025-900a-6fc76cbf8fb7"
            target="_blank"
            rel="noopener noreferrer"
            class="bg-white border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-bold py-3 px-6 rounded-full shadow-sm transition duration-300 text-center flex items-center gap-2"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="bg-white border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white font-bold py-3 px-6 rounded-full shadow-sm transition duration-300 text-center flex items-center gap-2"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="bg-white border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white font-bold py-3 px-6 rounded-full shadow-sm transition duration-300 text-center flex items-center gap-2"
